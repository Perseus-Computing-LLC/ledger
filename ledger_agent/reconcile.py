...
prices each event from the static table in :mod:`ledger_agent.pricing` and flags
...
it computes the difference between what Ledger debited and what was really billed
